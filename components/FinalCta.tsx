      ...
      <div className="relative mx-auto max-w-7xl overflow-hidden rounded-2xl bg-petrol-950 px-6 py-14 text-center text-cream-50 sm:px-12 sm:py-20">
        ...
        <div className="relative mx-auto max-w-3xl">
          ...
          <a
            ...
            className="mt-8 inline-flex min-h-12 items-center justify-center rounded-full bg-gold-500 px-8 py-3.5 text-base font-semibold text-petrol-950 shadow-lg shadow-black/15 transition-[background-color,transform] duration-200 hover:-translate-y-0.5 hover:bg-gold-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cream-50 focus-visible:ring-offset-2 focus-visible:ring-offset-petrol-950 motion-reduce:transform-none"
          >
